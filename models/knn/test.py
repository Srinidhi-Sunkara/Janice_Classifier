...
Tests a K-Nearest Neighbors classifier
'''
...
parser = argparse.ArgumentParser(description='Test a K-Nearest Neighbors classifier.')
...
parser.add_argument('-mdir', type=str, metavar='model file dir', default='models/knn/files/model.pkl', help='save file for trained model')
