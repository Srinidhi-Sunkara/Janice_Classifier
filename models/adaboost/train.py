...
Trains a AdaBoost classifier using Scikit-Learn
'''
...
parser = argparse.ArgumentParser(description='Train a AdaBoost classifier.')
...
parser.add_argument('-o', type=str, metavar='save file', default='models/adaboost/files/model.pkl', help='save file for trained model')
