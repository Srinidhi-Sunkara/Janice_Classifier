...
Tests a Random Forest classifier
'''
...
parser = argparse.ArgumentParser(description='Test a Random Forest classifier.')
...
parser.add_argument('-mdir', type=str, metavar='model file dir', default='models/random_forest/files/model.pkl', help='save file for trained model')
