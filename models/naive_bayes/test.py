...
parser = argparse.ArgumentParser(description='Test a Naive Bayes classifier.')
...
parser.add_argument('-mdir', type=str, metavar='model file dir', default='models/naive_bayes/files/model.pkl', help='save file for trained model')
